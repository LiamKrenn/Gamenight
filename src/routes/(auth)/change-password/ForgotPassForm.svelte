<script lang="ts">
	...
	export let forgotForm: SuperValidated<Infer<ForgotPasswordSchema>>;
	export let lockEmail: boolean;
...
<form method="POST" action="?/forgotPass" use:enhance>
	...
	<Form.Field {form} name="new_password">
		<Form.Control let:attrs>
			<Form.Label class="text-lg ">New password</Form.Label>
			<div class="relative">
				{#if passVisible}
					<Input
						class="focusring !mt-1 rounded-lg bg-slate-800 text-base"
	...
	<Form.Field {form} name="confirmPassword">
		<Form.Control let:attrs>
			<Form.Label class="text-lg ">Confirm New Password</Form.Label>
			<div class="relative">
